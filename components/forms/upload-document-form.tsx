  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end">
        <div className="flex-1">
          ...
          <div className="mt-3 rounded-[1.35rem] border border-dashed border-[#bfd1f4] bg-[#f8fbff] px-4 py-6">
            ...
            <p className="mt-3 text-sm leading-6 text-[#6d7686]">
              ResearchForge extracts page text, creates page-based chunks, stores
              embeddings in PostgreSQL + pgvector, and prepares grounded chat with
              page citations.
            </p>
          </div>
        </div>
        ...
        >
          {pending ? "Processing PDF..." : "Upload and process"}
        </button>
      </div>
